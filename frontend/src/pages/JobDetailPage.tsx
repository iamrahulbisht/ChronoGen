...
export default function JobDetailPage() {
  ...
  // @ts-ignore: dynamic penalty fields
  const rawBreakdownAny: any = rawBreakdown;
  if (rawBreakdownAny.hard_penalties || rawBreakdownAny.soft_penalties) {
      Object.assign(flatBreakdown, rawBreakdownAny.hard_penalties || {});
      Object.assign(flatBreakdown, rawBreakdownAny.soft_penalties || {});
  } else {
      Object.assign(flatBreakdown, rawBreakdownAny);
  }
