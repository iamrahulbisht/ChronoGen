...
from backend.engine.fitness import MAX_SCORE, evaluate_fitness
from backend.engine.initializer import create_random_chromosome
from backend.engine.models import Config
from backend.engine.operators import day_block_crossover, mutate, tournament_select
...
def run_hyper_heuristic_ga(config: Config, verbose: bool = True):
    from backend.engine.operators import mutate_day_move, mutate_room_reassign, mutate_slot_swap
